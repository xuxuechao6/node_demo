...
const privateKey = fs.readFileSync(path.join(__dirname, '../public/certs/privatekey.pem'));

/** Public certificate used for verification.  Note: you could also use the private key */
const publicKey = fs.readFileSync(path.join(__dirname, '../public/certs/certificate.pem'));
